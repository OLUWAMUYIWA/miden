...
impl System {
    ...
    #[inline(always)]
    pub fn get_ctx_at(&self, clk: usize) -> Felt {
        self.ctx_trace[clk]
    }
    ...
    pub fn advance_clock(&mut self) {
        ...
        self.clk_trace[self.clk] = Felt::from(self.clk as u32);
        self.fmp_trace[self.clk] = self.fmp;
        self.ctx_trace[self.clk] = Felt::from(self.ctx);
    }
    ...
    pub fn into_trace(mut self, trace_len: usize, num_rand_rows: usize) -> SysTrace {
        ...
        self.fmp_trace[clk..].fill(self.fmp);
        self.fmp_trace.resize(trace_len, self.fmp);
